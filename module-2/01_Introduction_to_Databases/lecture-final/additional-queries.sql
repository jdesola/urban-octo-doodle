...
-- The name, population, and GNP of all countries with a GNP greater than $1 trillion dollars 
-- and a population of less than 1 billion people
SELECT name, population, gnp FROM country WHERE population < 1000000000 AND gnp > 1000000;
...
-- The name, continent, GNP, and average life expectancy of all countries in Africa or Asia that have an average 
-- life expectancy of at least 70 years and a GNP between $1 million and $100 million dollars
SELECT * FROM country
