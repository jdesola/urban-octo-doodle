...
CREATE TABLE contact_address (
        ...
        constraint fk_contactaddress_contact_contact_id foreign key (contact_id) references contact(contact_id),
        constraint fk_contactaddress_address_address_id foreign key (address_id) references address(address_id)
);
