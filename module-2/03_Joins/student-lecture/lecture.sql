...
WHERE payment_id = 16666
GROUP BY payment.payment_id, payment.payment_date, customer.first_name, customer.last_name, 
        rental.return_date, film.title;                                    
...
SELECT c.name country, ci.name capital_city
FROM country AS c
