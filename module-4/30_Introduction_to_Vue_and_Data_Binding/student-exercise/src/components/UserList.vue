  ...
  computed:{
    filteredList() {
      return this.users.filter((user) => {
        return (user.firstName.toLowerCase().includes(this.filter.firstName.toLowerCase())) && (user.lastName.toLowerCase().includes(this.filter.lastName.toLowerCase()))
        && (user.emailAddress.toLowerCase().includes(this.filter.emailAddress.toLowerCase())) && (user.username.toLowerCase().includes(this.filter.username.toLowerCase()))
