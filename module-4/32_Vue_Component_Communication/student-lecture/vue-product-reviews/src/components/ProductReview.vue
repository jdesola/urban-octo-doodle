...
export default {
    ...
    data() {
        return {
            ...
            description: 'Host and plan the perfect cigar party for squirrels',
    ...
    computed: {
        ...
        filteredReviews() {
            // Filter the reviews based on a rating
            // return all reviews if that rating is 0
    ...
    methods: {
        numberOfReviewsForRating(starRating) {
            return this.reviews.reduce( (count, review) =>{
                return count + ( review.rating === starRating );
            }, 0);
        },
        addNewReview() {
