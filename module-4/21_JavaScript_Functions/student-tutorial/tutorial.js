 ...
 * @param {string} temperatureUnit temperature unit to be converted
 * @param {boolean} includeUnit include unit in conversion to string
 * @returns {string} returns converted temperature as string
 */
